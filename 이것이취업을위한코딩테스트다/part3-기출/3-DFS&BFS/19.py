...
def min_calculation(index, operation, calculation_result, add, sub, mul, div):
    ...
    if add != 0:
        result = min(result, min_calculation(index + 1, 0, calculation_result, add, sub, mul, div))
    if sub != 0:
        result = min(result, min_calculation(index + 1, 1, calculation_result, add, sub, mul, div))
    if mul != 0:
        result = min(result, min_calculation(index + 1, 2, calculation_result, add, sub, mul, div))
    if div != 0:
        result = min(result, min_calculation(index + 1, 3, calculation_result, add, sub, mul, div))
...
print(min_calculation(0, -1, answer, add, sub, mul, div))
